...
public class PageInfo2 {
	...
	public PageInfo2(int listCount, int currentPage, int pageLimit, int boardLimit) {
		super();
	...
	public PageInfo2(int listCount, int currentPage, int pageLimit, int boardLimit, int maxPage, int startPage,
			int endPage) {
		super();
		this.listCount = listCount;
		this.currentPage = currentPage;
	...
	public String toString() {
		return "PageInfo2 [listCount=" + listCount + ", currentPage=" + currentPage + ", pageLimit=" + pageLimit
