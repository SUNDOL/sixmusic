                ...
                <ul class="pagination">
                	...
                	<c:choose>
                		<c:when test="${pi.currentPage ne 1 }">
                			<li class="page-item"><a class="page-link" href="list.bo?currentPage=${pi.currentPage-1}&boardCate=3">Previous</a></li>
                		</c:when>
                	...
                	<c:forEach begin="${pi.startPage }" end="${pi.endPage }" var="p">
	                  <c:choose>
                		...
                		<c:otherwise>
	                    	<li class="page-item"><a class="page-link" href="list.bo?currentPage=${p}&boardCate=3">${p}</a></li>
                		</c:otherwise>
                		</c:choose>
                	</c:forEach>
                    ...
                    <c:choose>
						...
						<c:otherwise>
							<li class="page-item"><a class="page-link" href="list.bo?currentPage=${pi.currentPage +1}&boardCate=3">Next</a></li>
						</c:otherwise>                    
                    </c:choose>
                </ul>
            </div>
