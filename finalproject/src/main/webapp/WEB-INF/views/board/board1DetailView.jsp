...
<body>
	...
	<div class="content">
		...
		<div class="innerOuter">
			<h2>ANNOUNCEMENTS</h2>
			<br> <a class="btn btn-secondary" style="float: right;" onclick="javascript:history.go(-1);">목록으로</a>
			<br> <br>
			...
			<c:if test="${loginUser.memberId eq b.boardWriter }">
				...
				<form id="postForm" method="post">
					<input type="hidden" name="bno" value="${b.boardNo }"> <input
						...
						<!-- <input type="hidden" name="boardCate" value="${b.boardCate} ">-->
				</form>
            	...
            	function postFormSubmit(num){
					...
					var noh = $("<input>").prop("type","hidden").prop("name","boardCate").prop("value","${b.boardCate}");
					//form태그에 input요소 두개 넣기
					form.append(cBno).append(cFp).append(noh);
